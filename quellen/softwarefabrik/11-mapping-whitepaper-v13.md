...
| **6** Agent Lifecycle | Lebenszyklus eines Agenten | Als **Run**-Lebenszyklus modelliert: 7 Phasen, 14 Zustände, persistiert, wiederaufnehmbar, pausierbar, abbrechbar | ➕ |
...
| **15** Wirtschaftlichkeit & Kostenmodell | Token-Budget, ROI | ➕ Preistabelle je Modell (Input/Output/**Cached**), Kostenaggregation nach Projekt/Run/Provider/Mandant mit CSV-Export, harte Caps. **Wesentliche Ergänzung: Abo-Modus** — bei Flatrate-Abos sind Token-Kosten null, ein reines Token-ROI-Modell bildet die Realität nicht mehr ab | ➕ |
