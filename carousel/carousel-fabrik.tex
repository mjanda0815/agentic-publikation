...
% (Martin Janda, Sonderdruck zur Whitepaper-Fassung 2.4, August 2026)
%
...
% Erhebungsstand `main` nach Release 0.24.0 (7. August 2026).
...
% nach Release 0.24.0 (7. August 2026): 405 Produktivklassen, ~39.000 Zeilen
% Produktivcode, 275 Testklassen, 29 fachliche Slices, 32 Releases
% (0.1.0–0.24.0, April–August 2026), Coverage-Gate Line >= 85 % /
% Branch >= 81 % (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Der Stand}
  \gross{29 fachliche Slices, 32 Releases, vier Monate.}
  \vspace{48pt}
  \erl{Rund 39.000 Zeilen Produktivcode und 275 Testklassen; die
    Testabdeckung bricht den Build, wenn sie unter die Schwelle fällt
    (Line 85 \%, Branch 81 \%). Java 25, Spring Boot 4,
    ein Deployment-Artefakt. Stand: 7.\,August 2026, Release 0.24.0.}
\end{folie}
...
\begin{folie}{Der nächste Schritt — erreicht}
  \grossM{Erst die Koordination beweisen. Dann die Schreibrechte
    verteilen.}
  \vspace{48pt}
  \erl{Seit Release 0.22.0 schreiben mehrere Agenten parallel — wessen
    Schreibbereiche sich mit einem aktiven Task überschneiden, startet gar
    nicht erst. Seit 0.23.0 arbeiten sie gegen versionierte, gehashte
    Verträge; ändert sich einer, gehen die gebundenen Tasks automatisch in
    die Neuplanung. Und seit 0.24.0 braucht jede Planänderung einen Grund,
    der eine neue Eingabe trägt: Umsortieren allein genügt nicht.}
\end{folie}
