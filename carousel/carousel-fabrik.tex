...
% (Martin Janda, Sonderdruck zur Whitepaper-Fassung 2.5, August 2026)
%
...
% Erhebungsstand `main` nach Release 0.25.0 (8. August 2026).
...
% nach Release 0.25.0 (8. August 2026): 411 Produktivklassen, ~40.100 Zeilen
% Produktivcode, 279 Testklassen, 29 fachliche Slices, 33 Releases
% (0.1.0–0.25.0, April–August 2026), Coverage-Gate Line >= 85 % /
% Branch >= 81 % (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Der Stand}
  \gross{29 fachliche Slices, 33 Releases, vier Monate.}
  \vspace{48pt}
  \erl{Rund 40.100 Zeilen Produktivcode und 279 Testklassen; die
    Testabdeckung bricht den Build, wenn sie unter die Schwelle fällt
    (Line 85 \%, Branch 81 \%). Java 25, Spring Boot 4,
    ein Deployment-Artefakt. Stand: 8.\,August 2026, Release 0.25.0.}
\end{folie}
...
\begin{folie}{Der nächste Schritt — erreicht}
  ...
  \erl{Seit 0.22.0 schreiben mehrere Agenten parallel — wessen
    ...
    trägt. Und der verteilte Betrieb bleibt zurückgestellt, weil die eigene
    Voraussetzung — gemessener Bedarf — nicht erfüllt ist.}
\end{folie}
