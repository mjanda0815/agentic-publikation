...
% (Martin Janda, Sonderdruck zur Whitepaper-Fassung 2.8, August 2026)
%
...
% Release 0.29.0 (9. August 2026): 421 Produktivklassen, ~41.500 Zeilen
% Produktivcode, 287 Testklassen, 30 fachliche Slices, 37 Releases
% (0.1.0–0.29.0, April–August 2026), Coverage-Gate Line >= 85 % /
% Branch >= 81 % (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Der Stand}
  \gross{30 fachliche Slices, 37 Releases, vier Monate.}
  \vspace{48pt}
  \erl{Rund 41.500 Zeilen Produktivcode und 287 Testklassen; die
    Testabdeckung bricht den Build, wenn sie unter die Schwelle fällt
    (Line 85 \%, Branch 81 \%). Java 25, Spring Boot 4,
    ein Deployment-Artefakt. Stand: 9.\,August 2026, Release 0.29.0.}
\end{folie}
...
% bis 0.29.0, Stand 9. August 2026): Die Stufen 0 bis 4 und 6 sind
...
\begin{folie}{Sonderdruck}
  ...
  \erl{\textcolor{tinte}{\bfseries Sonderdruck und vollständiges Whitepaper:
    ...
    janda.io \textperiodcentered{} 38 Seiten, Stand: August 2026. Alle
