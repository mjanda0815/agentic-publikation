...
% (Martin Janda, Sonderdruck zur Whitepaper-Fassung 2.3, August 2026)
%
...
% Erhebungsstand `main` nach Release 0.22.0 (7. August 2026).
...
% nach Release 0.22.0 (7. August 2026): 388 Produktivklassen, ~36.600 Zeilen
% Produktivcode, 269 Testklassen, 28 fachliche Slices, 29 Releases
% (0.1.0–0.22.0, April–August 2026), Coverage-Gate Line >= 85 % /
% Branch >= 81 % (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Der Stand}
  \gross{28 fachliche Slices, 29 Releases, vier Monate.}
  \vspace{48pt}
  \erl{Rund 36.600 Zeilen Produktivcode und 269 Testklassen; die
    Testabdeckung bricht den Build, wenn sie unter die Schwelle fällt
    (Line 85 \%, Branch 81 \%). Java 25, Spring Boot 4,
    ein Deployment-Artefakt. Stand: 7.\,August 2026, Release 0.22.0.}
\end{folie}
...
% und 0.22.0, Stand 7. August 2026): Die Stufen 0 bis 2 sind umgesetzt.
% Seit 0.22.0 duerfen Tasks Produktivcode aendern; ein Task erklaert
% OWNED/READ_ONLY/PROTECTED-Pfadbereiche und startet nur, wenn sie sich mit
% keinem aktiven Task ueberschneiden (Vergleich auf Segmentgrenzen).
% Build-Dateien und Migrationsverzeichnis sind immer exklusiv. Eine Merge
% Queue fuehrt die Branches sequenziell in Planreihenfolge zusammen, das
% Integration Gate prueft den Gesamtstand. Stufen 3 bis 5 sind geplant.
% ============================================================================
\begin{folie}{Der nächste Schritt — erreicht}
  \grossM{Erst die Koordination beweisen. Dann die Schreibrechte
    verteilen.}
  \vspace{48pt}
  \erl{Seit Release 0.22.0 schreiben mehrere Agenten parallel — in
    getrennten Arbeitsverzeichnissen, koordiniert über einen
    Abhängigkeitsgraphen. Wessen Schreibbereiche sich mit einem aktiven
    Task überschneiden, startet gar nicht erst; Build-Dateien und
    Migrationen sind immer exklusiv. Eine Merge Queue führt die Branches in
    Planreihenfolge zusammen, ein Integration Gate prüft den Gesamtstand.
    Alles hinter einem standardmäßig deaktivierten Feature-Flag.}
\end{folie}
