...
% (Martin Janda, Fassung 2.5, August 2026)
%
...
% Release-Stand 0.28.0 (9. August 2026):
% 419 Produktivklassen, ~41.000 Zeilen Produktivcode, 30 fachliche Slices,
% 36 Releases (0.1.0 bis 0.28.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 30 fachliche Slices, 36 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 41.000 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 9.\,August 2026, Release 0.28.0.}
\end{folie}
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt bis Release 0.28.0, hinter einem standardmäßig
