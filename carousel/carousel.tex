...
% (Martin Janda, Fassung 2.3, August 2026)
%
...
% Entwicklungsstand main nach Release 0.22.0 (7. August 2026):
% 388 Produktivklassen, ~36.600 Zeilen Produktivcode, 28 fachliche Slices,
% 29 Releases (0.1.0 bis 0.22.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 28 fachliche Slices, 29 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 36.600 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 7.\,August 2026, Release 0.22.0.}
\end{folie}
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt seit Release 0.22.0, hinter einem standardmäßig
    deaktivierten Feature-Flag. Der Weg dorthin ging bewusst über die
    risikoärmste Stufe: erst parallele Analyse ohne Schreibrechte, dann die
    Schreibrechte — gebunden an eine Besitzregel, die überschneidende
    Schreibbereiche vor dem Start blockiert. Merge Queue und Integration
    Gate führen danach zusammen.}
\end{folie}
