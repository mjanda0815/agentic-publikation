...
% Entwicklungsstand main nach Release 0.20.0 (6. August 2026):
% 364 Produktivklassen, ~33.200 Zeilen Produktivcode, 28 fachliche Slices,
% 27 Releases (0.1.0 bis 0.20.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 28 fachliche Slices, 27 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 33.200 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 6.\,August 2026, Release 0.20.0.}
\end{folie}
...
% ============================================================================
\begin{folie}{Nächster Schritt — in Vorbereitung}
  ...
  \erl{Ein Feature wird in einen Task Graph zerlegt. Unabhängige Tasks
    sollen als isolierte Child Runs arbeiten — jeweils mit eigenem Branch
    oder Worktree und genau einem Schreiber. Erste Architekturvorbereitungen
    sind in Release 0.20.0 umgesetzt; produktiv nutzbare parallele Workflows,
    Merge Coordinator und Integration Gate sind geplant.}
\end{folie}
...
\begin{folie}{Whitepaper}
  ...
  \erl{\textcolor{tinte}{\bfseries Vollständiges Whitepaper:
    ...
    janda.io \textperiodcentered{} Überarbeitete und erweiterte Fassung 2.1,
    Stand: August 2026.}
\end{folie}
