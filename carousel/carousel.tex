...
% Entwicklungsstand main nach Release 0.25.0 (8. August 2026):
% 411 Produktivklassen, ~40.100 Zeilen Produktivcode, 29 fachliche Slices,
% 33 Releases (0.1.0 bis 0.25.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 29 fachliche Slices, 33 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 40.100 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 8.\,August 2026, Release 0.25.0.}
\end{folie}
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt bis Release 0.25.0, hinter einem standardmäßig
    ...
    statt Sammelkategorie. Der verteilte Betrieb bleibt zurückgestellt,
