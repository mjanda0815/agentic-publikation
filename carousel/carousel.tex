...
% (Martin Janda, Fassung 2.8, August 2026)
%
...
% ein — Folie 9 nennt den bis 0.29.0 umgesetzten Stand (Roadmap-Stufen 0 bis 4
...
% Release-Stand 0.29.0 (9. August 2026):
% 421 Produktivklassen, ~41.500 Zeilen Produktivcode, 30 fachliche Slices,
% 37 Releases (0.1.0 bis 0.29.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 30 fachliche Slices, 37 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 41.500 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 9.\,August 2026, Release 0.29.0.}
\end{folie}
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt bis Release 0.29.0, hinter einem standardmäßig
...
\begin{folie}{Whitepaper}
  ...
  \erl{\textcolor{tinte}{\bfseries Vollständiges Whitepaper:
    ...
    janda.io \textperiodcentered{} Überarbeitete und erweiterte Fassung 2.8,
    Stand: August 2026.}
\end{folie}
