...
% (Martin Janda, Fassung 2.2, August 2026)
%
...
% Entwicklungsstand main nach Release 0.21.0 (6. August 2026):
% 376 Produktivklassen, ~35.000 Zeilen Produktivcode, 28 fachliche Slices,
% 28 Releases (0.1.0 bis 0.21.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 28 fachliche Slices, 28 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 35.000 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 6.\,August 2026, Release 0.21.0.}
\end{folie}
...
% ============================================================================
\begin{folie}{Der Weg dorthin}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Seit Release 0.21.0 ist die risikoärmste Stufe umgesetzt — hinter
    einem standardmäßig deaktivierten Feature-Flag: Mehrere Agenten
    analysieren parallel in getrennten Arbeitsverzeichnissen, ein
    Synthese-Schritt führt sie zusammen — und keiner von ihnen darf
    schreiben. Paralleles Schreiben, Merge Coordinator und Integration Gate
    folgen. Erst die Koordination beweisen, dann die Schreibrechte
    verteilen.}
\end{folie}
