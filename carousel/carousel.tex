...
% (Martin Janda, Fassung 2.9, August 2026)
%
...
% ein — Folie 9 nennt den bis 0.30.0 umgesetzten Stand (Roadmap-Stufen 0 bis 4
% und 6, Koordinationsschicht aus 5) samt Feature-Flag-Vorbehalt; nur der
% verteilte Betrieb (5b) bleibt zurückgestellt.
...
% 421 Produktivklassen, ~41.700 Zeilen Produktivcode, 30 fachliche Slices,
% 38 Releases (0.1.0 bis 0.30.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 30 fachliche Slices, 38 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 41.700 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 9.\,August 2026, Release 0.30.0.}
\end{folie}

% ============================================================================
% FOLIE 9 — Stand und Roadmap (Stufen 0 bis 4 und 6 umgesetzt, von Stufe 5
% die Koordinationsschicht; verteilter Betrieb zurückgestellt)
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt bis Release 0.30.0, hinter einem standardmäßig
    ...
    an eine Besitzregel —, dann versionierte Verträge, dann
    begründungspflichtige Planänderungen, dann Merge-Konflikte als Diagnose
    statt Sammelkategorie, zuletzt Koordinationsschicht und eine Messung,
    die ihre Lücken ausweist. Der verteilte Betrieb bleibt zurückgestellt,
    solange der Bedarf nicht gemessen ist.}
\end{folie}
...
\begin{folie}{Whitepaper}
  ...
  \erl{\textcolor{tinte}{\bfseries Vollständiges Whitepaper:
    ...
    janda.io \textperiodcentered{} Überarbeitete und erweiterte Fassung 2.9,
    Stand: August 2026.}
\end{folie}
