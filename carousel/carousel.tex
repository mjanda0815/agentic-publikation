...
% Release-Stand 0.27.0 (8. August 2026):
% 417 Produktivklassen, ~40.600 Zeilen Produktivcode, 30 fachliche Slices,
% 35 Releases (0.1.0 bis 0.27.0, April–August 2026),
% Coverage-Gate Line >= 85 % / Branch >= 81 %
% (JaCoCo, buildbrechend).
% ============================================================================
\begin{folie}{Referenzimplementierung}
  \gross{Vom Konzept zum System: 30 fachliche Slices, 35 Releases in vier
    Monaten.}
  \vspace{48pt}
  \erl{Rund 40.600 Zeilen Produktivcode, Testabdeckung als buildbrechendes
    ...
    Stand: 8.\,August 2026, Release 0.27.0.}
\end{folie}
...
\begin{folie}{Der Stand}
  \grossM{Parallelität entsteht aus Abhängigkeiten — nicht aus
    Agentenrollen.}
  \vspace{48pt}
  \erl{Umgesetzt bis Release 0.27.0, hinter einem standardmäßig
