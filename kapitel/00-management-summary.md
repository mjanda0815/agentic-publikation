...
Diese Ebene ist seit Release 0.25.0 umgesetzt — hinter einem standardmäßig deaktivierten Feature-Flag. Der Weg dorthin führte bewusst über die risikoärmste Stufe: 0.21.0 ließ mehrere Agenten parallel analysieren, ohne dass einer schreiben durfte; 0.22.0 fügte die Schreibrechte hinzu, band sie aber an eine Besitzregel — wessen Schreibbereiche sich mit einem aktiven Task überschneiden, startet nicht; 0.23.0 gab den gemeinsamen Verträgen eine versionierte, gehashte Fassung, gegen die gearbeitet wird; 0.24.0 machte jede Planänderung begründungspflichtig und attestierbar; 0.25.0 verwandelte den Sammelbegriff Merge-Konflikt in eine Diagnose mit Handlungsempfehlung. Der verteilte Betrieb über mehrere Hosts bleibt bewusst zurückgestellt, solange der Bedarf nicht gemessen ist.
