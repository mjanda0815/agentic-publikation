...
> AP-3 ist vollständig implementiert (Feature-Flag, standardmäßig
> deaktiviert): Tasks werden aus einem Abhängigkeitsgraphen parallelisiert
> und laufen in getrennten Arbeitsverzeichnissen — zunächst nur lesend,
> inzwischen auch schreibend und gebunden an versionierte Verträge, deren
> Änderung betroffene Tasks automatisch auf Neuplanung setzt
> (Release-Verlauf: Tabelle in 19.10). AP-2 gilt dabei Workflow-weit: Ein Task startet nur,
